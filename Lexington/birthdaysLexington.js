...
function funPackage(){
  var a = document.getElementById("fun-in-the-sun-package");
  var b = document.getElementById("full-sail-package");
  var c = document.getElementById("booking-link");

  var x = document.getElementById("fun-in-the-sun");
  var y = document.getElementById("full-sail");

  a.className = "package-button-selected";
  b.className = "package-button-unselected";
  c.href = "https://malibujacks.centeredgeonline.com/event/description/75e3bbf2-d91f-4d3e-91bd-eac6a3b852a2";

  x.className = "package-div-displayed-fun";
  y.className = "package-div-hidden";
}

function fullSailPackage(){
  var a = document.getElementById("full-sail-package");
  var b = document.getElementById("fun-in-the-sun-package");
  var c = document.getElementById("booking-link");

  var x = document.getElementById("full-sail");
  var y = document.getElementById("fun-in-the-sun");

  a.className = "package-button-selected";
  b.className = "package-button-unselected";
  c.href = "https://malibujacks.centeredgeonline.com/event/description/f3e692c6-15fa-4e1c-bd60-c081cac695e6";
